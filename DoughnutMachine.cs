...
namespace Irimies_Rares_Lab2
{
    class DoughnutMachine : Component
    {
        ...
        public event DoughnutCompleteDelegate DoughnutComplete; // Event triggered when Doughnut is ready
        ...
        public int Interval // Set timer properties
        {
            set
            {
        ...
        public DoughnutMachine() //Timer initialization
        {
            InitializeComponent();
        }

        private void doughnutTimer_Tick(object sender, EventArgs e) //Event handler
        {
        ...
        public void MakeDoughnuts(DoughnutType dFlavor) // Create the correct doughnut type
        {
